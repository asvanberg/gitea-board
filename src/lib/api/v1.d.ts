...
export interface definitions {
  ...
  IssueTemplate: {
    about?: string;
    assignees?: definitions["IssueTemplateStringSlice"];
    body?: definitions["IssueFormField"][];
    content?: string;
    file_name?: string;
    labels?: definitions["IssueTemplateStringSlice"];
    name?: string;
    ref?: string;
    title?: string;
  };
  ...
  PullRequest: {
    ...
    requested_reviewers_teams?: definitions["Team"][];
    /**
     * Format: int64
...
export interface responses {
  ...
  MergeUpstreamRequest: {
    schema: definitions["MergeUpstreamRequest"];
  };
  MergeUpstreamResponse: {
    schema: definitions["MergeUpstreamResponse"];
  };
  /** Milestone */
  Milestone: {
  ...
  /** TagProtection */
  TagProtection: {
    schema: definitions["TagProtection"];
  };
  /** TagProtectionList */
  TagProtectionList: {
    schema: definitions["TagProtection"][];
...
export interface operations {
  ...
  repoUpdateBranchProtectionPriories: {
    parameters: {
      ...
      body: {
        body?: definitions["UpdateBranchProtectionPriories"];
      };
    };
    responses: {
      204: responses["empty"];
  ...
  repoUpdateBranch: {
    parameters: {
      ...
      body: {
        body?: definitions["UpdateBranchRepoOption"];
      };
    };
    responses: {
      204: responses["empty"];
  ...
  repoMergeUpstream: {
    parameters: {
      ...
      body: {
        body?: definitions["MergeUpstreamRequest"];
      };
    };
    responses: {
      200: responses["MergeUpstreamResponse"];
      400: responses["error"];
      404: responses["notFound"];
    };
  };
  ...
  repoListTagProtection: {
    ...
    responses: {
      200: responses["TagProtectionList"];
    };
  };
  repoCreateTagProtection: {
    parameters: {
      ...
      body: {
        body?: definitions["CreateTagProtectionOption"];
      };
    };
    responses: {
      201: responses["TagProtection"];
      403: responses["forbidden"];
      404: responses["notFound"];
      422: responses["validationError"];
      423: responses["repoArchivedError"];
  ...
  repoEditTagProtection: {
    parameters: {
      ...
      body: {
        body?: definitions["EditTagProtectionOption"];
      };
    };
    responses: {
      200: responses["TagProtection"];
